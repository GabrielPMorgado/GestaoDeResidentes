...
-- Desabilitar verificações temporariamente para evitar erros
SET FOREIGN_KEY_CHECKS = 0;
SET SQL_MODE = 'NO_AUTO_VALUE_ON_ZERO';

-- ============================================
-- REMOVER TABELAS EXISTENTES (ORDEM CORRETA)
-- ============================================

DROP TABLE IF EXISTS pagamentos_salarios;
DROP TABLE IF EXISTS pagamentos_mensalidades;
...
CREATE TABLE profissionais (
  ...
  INDEX idx_data_cadastro_prof (data_cadastro)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ============================================
-- TABELA: despesas_gerais (FINANCEIRO)
-- ============================================
...
-- ============================================
-- TABELA: pagamentos_mensalidades (FINANCEIRO)
-- ============================================
...
-- ============================================
-- TABELA: pagamentos_salarios (FINANCEIRO)
-- ============================================
